...
import { RiLinkedinFill as LinkedinIcon, RiFacebookFill as FacebookIcon,
  RiTwitterFill as TwitterIcon } from 'react-icons/ri';
...
background: #aaffa9; /* fallback for old browsers */
  background: -webkit-linear-gradient(to right, #aaffa9, #11ffbd); /* Chrome 10-25, Safari 5.1-6 */
...
clip-path: polygon(50% 0%, 100% 0, 100% 35%, 100% 66%, 81% 74%, 50% 83%, 22% 76%, 0% 70%, 0% 35%, 0 0);
max-width: 100%;
height: 40vh;
`;
...
const UserPanel = () => {
  ...
  return (
    <Container>
      <LeftNavbar>
        <li><AccountIcon />ACCOUNT</li>
          <li><ResumeIcon/>RESUME</li>
          <li><WorkIcon />WORKS</li>
          <li><BlogIcon />BLOG</li>
          <li><ContactsIcons/>CONTACT</li>
      </LeftNavbar>
      <MainContainer>
